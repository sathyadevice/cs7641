...
public class diabetes {
    ...
    private static int inputLayer = 30, hiddenLayer=10, outputLayer = 1, trainingIterations = 5000;
...
//                write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "diabetes_results.csv", final_result, true);
