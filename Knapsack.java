...
public class Knapsack {
    ...
    public static void main(String[] args) {
        ...
        for (int iter : iters) {
            ...
            write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "knapsack_results.csv", final_result, true);
        }

        int [] samples = {10, 20, 40, 80, 160,200,220,240,260, 280};
        ...
        for (int i = 0; i < samples.length; i++) {
            ...
            write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "knapsack_mimic_results.csv", final_result, true);
        }
    }
