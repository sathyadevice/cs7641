...
public class TravellingSalesman {
    ...
    public static void main(String[] args) {
        ...
        for (int iter : iters) {
            ...
            write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "travelingsalesman_results.csv", final_result, true);
        }
         ...
         write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "travelingsalesman_ga_results.csv", final_result, true);
         }
    }
}