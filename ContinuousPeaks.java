...
public class ContinuousPeaks {
    ...
    public static void main(String[] args) {
        ...
        for (int iter : iters) {
            ...
            write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "continuousPeaks_results.csv", final_result, true);
        }
        ...
        for (int i = 0; i < coolings.length; i++){
            ...
            write_output_to_file("..\\ABAGAIL\\src\\opt\\sconjeevaram\\Optimization_Results", "continuousPeaks_sa_results.csv", final_result, true);
        }        
    }
}